...
import com.myproject.exception.message.ApiResponseError;
...
@ControllerAdvice // merkezi exceptionları handle etmek icin kullanıyoruz
public class SafeRentExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    // override ederek istedigim yapida(ApiResponse) cevap verilmesini saglamak
